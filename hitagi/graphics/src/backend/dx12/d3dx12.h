        ...
        case D3D_ROOT_SIGNATURE_VERSION_1_0:
            switch (pRootSignatureDesc->Version) {
                ...
                case D3D_ROOT_SIGNATURE_VERSION_1_1: {
                    ...
                    void*        pParameters    = (desc_1_1.NumParameters > 0) ? HeapAlloc(GetProcessHeap(), 0, ParametersSize) : nullptr;
                    if (desc_1_1.NumParameters > 0 && pParameters == nullptr) {
                        hr = E_OUTOFMEMORY;
                    }
                        ...
                        for (UINT n = 0; n < desc_1_1.NumParameters; n++) {
                            ...
                            switch (desc_1_1.pParameters[n].ParameterType) {
                                ...
                                case D3D12_ROOT_PARAMETER_TYPE_DESCRIPTOR_TABLE:
                                    ...
                                    void*        pDescriptorRanges    = (table_1_1.NumDescriptorRanges > 0 && SUCCEEDED(hr)) ? HeapAlloc(GetProcessHeap(), 0, DescriptorRangesSize) : nullptr;
                                    if (table_1_1.NumDescriptorRanges > 0 && pDescriptorRanges == nullptr) {
                                        hr = E_OUTOFMEMORY;
                                    }
