...
public:
    ...
    virtual auto RenderScene(const asset::Scene& scene, const asset::CameraNode& camera, const gfx::ViewPort& viewport, std::optional<math::vec2u> texture_size = std::nullopt) -> gfx::ResourceHandle = 0;
